        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container py-2">
                    <Link className="navbar-brand" to="/">Ma Classe</Link>
                        ...
                        <ul className="navbar-nav ms-auto nav_ul align-items-center">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a className="dropdown-item" href="/Français">Français</a></li>
                                </ul>
                            </li>
                            <div className="mx-3">
                                <button type="button" onClick={handleLoginClick} className="btn1 mx-2">Se connecter</button>
                                <button type="button"  className="btn2 mx-2">S'inscrire</button>
                            </div>
